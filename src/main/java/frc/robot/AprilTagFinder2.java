...
public class AprilTagFinder2 {
    ...
    public void startDetection() {
        ...
        while (!Thread.interrupted()) {
            ...
            Imgproc.putText(mat, String.valueOf(result.getId()),pt2,Imgproc.FONT_HERSHEY_COMPLEX,2,green,7);
            }
